...
public class UserService implements AbstractUserService {
  ...
  public User getOrCreate(String oauthKey,
      String displayName) { // TODO: 2/29/2024 Add parameters for additional user profile info for the bearer token.
  ...
  public Optional<User> get(UUID key, User requester) {
    return userRepository
        .findUserByKey(key); // TODO: 2/29/2024  Apply access-control ...
  }
